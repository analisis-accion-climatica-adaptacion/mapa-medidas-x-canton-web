...
## Entradas
**1. Capa geoespacial de cantones de Costa Rica**  
...
**2. Datos de medidas de acción climática en adaptación por cantón**  

Archivo: ```datos/medidas-adaptacion-x-canton.csv```  
